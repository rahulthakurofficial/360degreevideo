import {
  ...
  _Math,
  init_three_module
} from "./chunk-D4J4NP25.js";
import "./chunk-DZZM6G22.js";

// node_modules/panolens/build/panolens.module.js
init_three_module();
var version = "0.12.1";
var dependencies = { three: "^0.105.2" };
var REVISION2 = version.split(".")[1];
var VERSION = version;
var THREE_REVISION = dependencies.three.split(".")[1];
var THREE_VERSION = dependencies.three.replace(/[^0-9.]/g, "");
var CONTROLS = { ORBIT: 0, DEVICEORIENTATION: 1 };
var MODES = { UNKNOWN: 0, NORMAL: 1, CARDBOARD: 2, STEREO: 3 };
var DataImage = {
        ...
        (function(x2, y2) {
          if (useWebGL) {
            const texture = TextureLoader.load(url, null, function() {
              self2.composeFromTile(x2, y2, texture);
            });
          } else {
            const img = new Image();
            img.addEventListener("load", function() {
              self2.composeFromTile(x2, y2, this);
            });
            img.crossOrigin = "";
            img.src = url;
          }
  ...
  onMouseMove: function(event) {
    ...
    switch (inputCount) {
      case 1:
        const x = event.clientX >= 0 ? event.clientX : event.touches[0].clientX;
        const y = event.clientY >= 0 ? event.clientY : event.touches[0].clientY;
        const angleX = _Math.degToRad(x - this.userMouse.x) * 0.4;
...
Viewer.prototype = Object.assign(Object.create(EventDispatcher.prototype), {
  ...
  enableControl: function(index) {
    ...
    this.control.update();
    this.activateWidgetItem(index, void 0);
  },
  /**
  ...
  outputPosition: function() {
    ...
    if (intersects.length > 0) {
      ...
      switch (this.options.output) {
        case "event":
          this.dispatchEvent({ type: "position-output", position });
          break;
        case "console":
  ...
  onTap: function(event, type) {
    ...
    const intersect = intersects.length > 0 ? intersects[0].object : void 0;
    ...
    if (type === "click") {
      this.panorama.dispatchEvent({ type: "click", intersects, mouseEvent: event });
      ...
      this.panorama.dispatchEvent({ type: "hover", intersects, mouseEvent: event });
